<template>
  <div class="dashboard-page screen">
    ...
    <div class="main-container screen">
        ...
        <nav>
          <ul>
            ...
            <div class="submenu" v-if="showSubMenu.planning && isSidebarOpen" ref="planningsubmenu"  @click.stop>
                <ul>
                  <li @click="switchDashboard('Planning Summary')"><a href="#" title="Summary"><i class="fas fa-file"></i><span>Summary</span></a></li>
      ...
      <div id="embed-title" v-if="dashboardType === 'Planning Summary'">
        <h2>{{ heading }}</h2>
        <div id="embed-container" class="scrollable-container">
          <PlanningSummary />
        </div>
...
import TableauEmbed from "@/components/TableauBoard.vue";
...
export default {
  components: { HomeDashboard, YieldChartGrid, TableauEmbed, PlanningSummary},
  data() {
    return {
      showSubMenu: {
        general: false,
